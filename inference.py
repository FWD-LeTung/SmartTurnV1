...
ONNX_MODEL_PATH = "C:/Users/letung373/Desktop/Lumi/model_int8.onnx"
ONNX_MODEL_PATH2 = "C:/Users/letung373/Downloads/smart-turn-v3.0.onnx"
...
session2 = build_session(ONNX_MODEL_PATH2)
...
def predict_endpoint2(audio_array):
    ...
    # Run ONNX inference
    outputs = session2.run(None, {"input_features": input_features})
